...
| ------------------------------------ | -------------------- | ------------------------------------------------- | -------------------------------------------------- | -------- |
| `features/vods/VodCard.tsx`          | 317–321, 343–347     | `bg-blue-500/30`, `bg-emerald-500/80`, `bg-zinc-500/30`, `bg-amber-500/80`, `bg-orange-500/80`, `bg-red-500/80` | `bg-info`, `bg-success`, `bg-surface-1`, `bg-warning`, `bg-warning`, `bg-danger` utilities OR neutral surface + glyph variant | **Mission 2** (full VodCard rewrite per ADR-0039) |
